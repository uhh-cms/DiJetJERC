...
class PlotAlphaExtrapolation(
    ...
    def run(self):
        ...
        for response_key, response_cfg in self.postprocessor_inst.responses.items():
            ...
            ref_object = next(iter_flat_dict(inputs[response_key]["width"]))
            ...
            for bv_bins in product_dict({
                ...
                **bv_bin_lists,
                ...
                for sample, level in itertools.product(self.samples, self.levels):
                    ...
                    h_in = inputs[response_key]["width"][sample][level]
                    ...
                    # plot widths
                    alpha_var_key = self.postprocessor_inst.extrapolation_var_key
                    alpha_edges = h_sliced.axes[variable_map[level][alpha_var_key]].edges
                    plot_xy(
                    ...
                    h_inter = inputs[response_key]["extrapolation"][sample][level]["intercepts"]
                    h_slope = inputs[response_key]["extrapolation"][sample][level]["slopes"]
