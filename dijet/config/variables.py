...
def add_uhh2_synch_variables(config: od.Config) -> None:
    ...
    variables = {
        ...
        "jet2_pt": {
            ...
            "diff_binning": np.linspace(-75, 75, 101),
            "label": r"Jet 2 $p_{T}$",
        },
        "jet3_pt": {
        ...
        "alpha": {
            ...
            "binning": np.linspace(0.0, 1.02, 101),
            "diff_binning": np.linspace(-1.02, 1.02, 101),
            "label": r"$\alpha$",
        },
        "alpha_raw": {
            "expression_cf": "dijets.alpha_raw",
            "expression_uhh2": "uhh2.alpha",
            "binning": np.linspace(0.0, 1.02, 101),
            "diff_binning": np.linspace(-1.02, 1.02, 101),
            "label": r"$\alpha$ (raw)",
        ...
        "reference_jet_pt": {
            ...
            "scale": "log",
            "binning": np.logspace(np.log10(5), np.log10(200), 101),
            "diff_binning": np.linspace(-100, 100, 101),
