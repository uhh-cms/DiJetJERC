...
action() {
    ...
    local cf_sandbox_dir="${CF_BASE}/sandboxes"
    ...
    export CF_VENV_REQUIREMENTS="${cf_sandbox_dir}/columnar.txt,${this_dir}/columnar_extra.txt,${cf_sandbox_dir}/dev.txt"

    source "${cf_sandbox_dir}/_setup_venv.sh" "$@"
}
action "$@"
